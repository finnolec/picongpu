    ...
    namespace templates
    {
        ...
        namespace gaussian
        {
            ...
            public:
                ...
                HDINLINE float_T calcEx_Linear_X(const float3_64& pos, const float_64 time) const;
                 ...
                 *  for calculating the field
                 * \return Ex-field component of the non-rotated Gaussian laser field in SI units */
                HDINLINE float_T calcEy_Linear_X(const float3_64& pos, const float_64 time) const;
                 ...
                 *  for calculating the field
                 * \return Ex-field component of the non-rotated Gaussian laser field in SI units */
                HDINLINE float_T calcEz_Linear_X(const float3_64& pos, const float_64 time) const;
                 ...
                 *  for calculating the field
                 * \return Ex-field component of the non-rotated Gaussian laser field in SI units */
                HDINLINE float_T calcEx_Linear_YZ(const float3_64& pos, const float_64 time) const;
                 ...
                 *  for calculating the field
                 * \return Ex-field component of the non-rotated Gaussian laser field in SI units */
                HDINLINE float_T calcEy_Linear_YZ(const float3_64& pos, const float_64 time) const;
                 ...
                 *  for calculating the field
                 * \return Ex-field component of the non-rotated Gaussian laser field in SI units */
                HDINLINE float_T calcEz_Linear_YZ(const float3_64& pos, const float_64 time) const;
                ...
                HDINLINE float3_X getEfield_Normalized_Linear_X(
                 ...
                 * \param cellIdx The total cell id counted from the start at timestep 0
                 * \return Efield vector of the rotated Gaussian laser field in SI units */
                HDINLINE float3_X getEfield_Normalized_Linear_YZ(
                    const pmacc::math::Vector<floatD_64, detail::numComponents>& eFieldPositions_SI,
                    const float_64 time) const;
            };
