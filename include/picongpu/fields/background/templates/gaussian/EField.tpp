...
namespace picongpu
{
    ...
    namespace templates
    {
        ...
        namespace gaussian
        {
            ...
            HDINLINE float3_X EField::getEfield_Normalized_Linear_X(
                ...
                const float_64 time) const
            {
                ...
                return float3_X(float_X(calcEx_Linear_X(pos[0], time)), float_X(Ey_rot), float_X(Ez_rot));
            }

            HDINLINE float3_X EField::getEfield_Normalized_Linear_YZ(
                const pmacc::math::Vector<floatD_64, detail::numComponents>& eFieldPositions_SI,
                const float_64 time) const
            {
                typedef pmacc::math::Vector<float3_64, detail::numComponents> PosVecVec;
                ...
                /* Finally, the E-field normalized to the peak amplitude. */
                return float3_X(float_X(calcEx_Linear_YZ(pos[0], time)), float_X(Ey_rot), float_X(Ez_rot));
            }
             ...
             *             the field */
            HDINLINE EField::float_T EField::calcEx_Linear_X(const float3_64& pos, const float_64 time) const
            {
             ...
             * \param time Absolute time (SI, including all offsets and transformations) for calculating
             *             the field */
            HDINLINE EField::float_T EField::calcEy_Linear_X(const float3_64& pos, const float_64 time) const
            {
                return float_T(0.0);
            }
             ...
             * \param time Absolute time (SI, including all offsets and transformations) for calculating
             *             the field */
            HDINLINE EField::float_T EField::calcEz_Linear_X(const float3_64& pos, const float_64 time) const
            {
                using complex_T = pmacc::math::Complex<float_T>;
                using complex_64 = pmacc::math::Complex<float_64>;
                /* Unit of speed */
             ...
             * \param time Absolute time (SI, including all offsets and transformations) for calculating
             *             the field */
            HDINLINE EField::float_T EField::calcEx_Linear_YZ(const float3_64& pos, const float_64 time) const
            {
             ...
             * \param time Absolute time (SI, including all offsets and transformations) for calculating
             *             the field */
            HDINLINE EField::float_T EField::calcEy_Linear_YZ(const float3_64& pos, const float_64 time) const
            {
             ...
             * \param time Absolute time (SI, including all offsets and transformations) for calculating
             *             the field */
            HDINLINE EField::float_T EField::calcEz_Linear_YZ(const float3_64& pos, const float_64 time) const
            {
